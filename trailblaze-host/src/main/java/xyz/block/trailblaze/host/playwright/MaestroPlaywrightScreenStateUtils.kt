 ...
 */
object MaestroPlaywrightScreenStateUtils {
  ...
  fun getMaestroViewHierarchy(currentPage: Page): TreeNode {
    val jsCode = """
      $MAESTRO_WEB_JS
    window.maestro.getContentDescription();
    """.trimIndent()

    val domJsonString = currentPage.evaluate(jsCode)
