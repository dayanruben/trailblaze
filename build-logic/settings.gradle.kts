...
// file. `build-logic` is an included build, so it reads its OWN `gradle.properties` (next to
// this file) for the defaults — they are duplicated from the root `gradle.properties` on purpose.
//
