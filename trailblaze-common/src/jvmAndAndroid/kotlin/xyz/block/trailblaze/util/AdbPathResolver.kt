 ...
 *
 * All code that spawns adb processes should invoke [ADB_COMMAND] (the resolved command)
 * instead of a hard-coded `"adb"` string. [AndroidHostAdbUtils.createAdbCommandProcessBuilder]
 * already does this.
 *
