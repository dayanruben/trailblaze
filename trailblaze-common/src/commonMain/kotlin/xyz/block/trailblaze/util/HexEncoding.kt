 ...
 *
 * Hand-rolled instead of `"%02x".format(it)` because `String.format` is JVM-only and this
 * lives in commonMain; the output is byte-identical (two's-complement low 8 bits, lowercase,
 * zero-padded).
 */
