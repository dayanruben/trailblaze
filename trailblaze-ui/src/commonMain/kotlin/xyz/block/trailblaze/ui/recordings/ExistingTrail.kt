...
data class ExistingTrail(
   ...
   * The platform is the first classifier. Returns null for trailblaze.yaml or unrecognized formats.
   */
   ...
   * "ios-iphone-portrait.trail.yaml"). Returns an empty list for trailblaze.yaml.
   */
