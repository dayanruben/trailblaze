...
// tokens (REPORT_DESIGN_TOKENS_CSS — one palette, no drift); everything below the token block is
...
export const PERF_REPORT_CSS = `${REPORT_DESIGN_TOKENS_CSS}
...
#tb-boot .tb-boot-title { font-size: var(--type-body); font-weight: var(--font-weight-emphasis); color: var(--txt); }
...
.idxhead h1 { font-size: 20px; line-height: 1.2; letter-spacing: -.01em; margin: 0; font-weight: var(--font-weight-emphasis); }
.idxhead .spacer { flex: 1; }
.idxsummary { display: flex; align-items: center; gap: var(--space-3); flex-wrap: wrap; margin-bottom: var(--space-4); }
.idxstat { color: var(--sub2); font-size: 13px; font-weight: var(--font-weight-emphasis); white-space: nowrap; }
...
.platchip { display: inline-block; margin-left: 8px; vertical-align: 2px; font-size: var(--type-micro); font-weight: var(--font-weight-emphasis); letter-spacing: .06em; text-transform: uppercase; color: var(--sub2); background: var(--bg3); border: 1px solid var(--line2); border-radius: var(--r-sm); padding: 1px 6px; white-space: nowrap; }
...
.idxfact .v { color: var(--sub2); font-size: var(--type-caption); font-weight: var(--font-weight-emphasis); margin-top: 1px; white-space: nowrap; font-variant-numeric: tabular-nums; }
...
.perf-header h1 { font-size: 16px; line-height: 1.2; letter-spacing: -.01em; margin: 0; font-weight: var(--font-weight-emphasis); white-space: nowrap; }
.perf-header .spacer { flex: 1; }
/* Selects share the interactive report's quiet control chrome (.quietlink: bg2 fill, line2
   border, r-sm radius, 32px height, emphasized sub2 text, accent hover). Native select arrows
   can't be themed, so the wrapper draws the chevron. */
.selectwrap { position: relative; display: inline-flex; min-width: 0; }
.selectwrap::after { content: ''; position: absolute; right: 10px; top: 50%; width: 6px; height: 6px; margin-top: -4.5px; border-right: 1.75px solid var(--sub); border-bottom: 1.75px solid var(--sub); transform: rotate(45deg); pointer-events: none; }
.perf-select { appearance: none; -webkit-appearance: none; min-height: 32px; max-width: 380px; padding: 5px 26px 5px 9px; border: 1px solid var(--line2); border-radius: var(--r-sm); background: var(--bg2); color: var(--sub2); font-size: 11px; font-weight: var(--font-weight-emphasis); cursor: pointer; min-width: 0; text-overflow: ellipsis; }
...
.iconbtn { min-height: 32px; min-width: 32px; display: inline-flex; align-items: center; justify-content: center; gap: 6px; padding: 5px 9px; border: 1px solid var(--line2); border-radius: var(--r-sm); background: var(--bg2); color: var(--sub2); font-size: 11px; font-weight: var(--font-weight-emphasis); cursor: pointer; }
...
.stat .v { font-size: var(--type-small); font-weight: var(--font-weight-emphasis); font-variant-numeric: tabular-nums; white-space: nowrap; }
.stat .v .delta { font-weight: var(--font-weight-emphasis); margin-left: 6px; }
...
.perf-tooltip .tt-name { font-weight: var(--font-weight-emphasis); }
...
.perf-tab { border: none; background: none; color: var(--sub); font-size: var(--type-small); font-weight: var(--font-weight-emphasis); padding: 6px 12px 8px; cursor: pointer; border-radius: var(--r-sm) var(--r-sm) 0 0; border-bottom: 2px solid transparent; }
...
table.perf th { position: sticky; top: 0; z-index: 2; text-align: left; font-size: var(--type-micro); text-transform: uppercase; letter-spacing: .08em; color: var(--sub); font-weight: var(--font-weight-emphasis); padding: 6px 10px; background: var(--bg); border-bottom: 1px solid var(--line2); white-space: nowrap; }
...
.kindchip { display: inline-block; min-width: 52px; text-align: center; font-size: var(--type-micro); font-weight: var(--font-weight-emphasis); text-transform: uppercase; letter-spacing: .05em; border-radius: 99px; padding: 1px 8px; }
...
.pass-txt { color: var(--pass); font-weight: var(--font-weight-emphasis); }
.delta-pos { color: var(--fail); font-weight: var(--font-weight-emphasis); }
.delta-neg { color: var(--pass); font-weight: var(--font-weight-emphasis); }
...
.perf-inspector h3 { margin: 0 0 2px; font-size: var(--type-body); font-weight: var(--font-weight-emphasis); overflow-wrap: anywhere; }
