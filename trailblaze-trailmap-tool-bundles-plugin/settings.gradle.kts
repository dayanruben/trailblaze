...
// file. This is an included build, so it reads its OWN `gradle.properties` (next to this file)
// for the defaults — they are duplicated from the root `gradle.properties` on purpose.
//
...
rootProject.name = "trailblaze-trailmap-tool-bundles-plugin"
