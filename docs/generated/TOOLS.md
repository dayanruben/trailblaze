...
- [compose_scroll](functions/custom/compose_scroll.md)
- [compose_type](functions/custom/compose_type.md)
- [compose_wait](functions/custom/compose_wait.md)
- [takeSnapshot](functions/custom/takeSnapshot.md)

## compose_verification
- [compose_verify_element_visible](functions/custom/compose_verify_element_visible.md)
- [compose_verify_text_visible](functions/custom/compose_verify_text_visible.md)
...
- [dumpMemory](functions/custom/dumpMemory.md)
...
- [setActiveToolSets](functions/custom/setActiveToolSets.md)
...
## revyl_core
- [revyl_back](functions/custom/revyl_back.md)
- [revyl_doubleTap](functions/custom/revyl_doubleTap.md)
- [revyl_navigate](functions/custom/revyl_navigate.md)
- [revyl_pressKey](functions/custom/revyl_pressKey.md)
- [revyl_swipe](functions/custom/revyl_swipe.md)
- [revyl_tap](functions/custom/revyl_tap.md)
- [revyl_type](functions/custom/revyl_type.md)

## revyl_verification
- [revyl_assert](functions/custom/revyl_assert.md)

## verification
- [assertNotVisibleWithText](functions/custom/assertNotVisibleWithText.md)
...
- [web_verify_value](functions/custom/web_verify_value.md)
