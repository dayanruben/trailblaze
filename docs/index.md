...
Every trail produces a rich, replayable report. This one is generated by CI straight
from the [`examples/`](https://github.com/block/trailblaze/tree/main/examples) trails in
this repo — no mockup. Click through for the full interactive report, or browse the
[Report Gallery](reports.md) for more.

[![Animated timeline of a recorded Trailblaze run against live Wikipedia](report-assets/wikipedia/timeline.webp)](reports.md)
