...
from the Android, iOS, and web trails in this repo — no mockups. Click through and each one
opens in the browser-based [report viewer](report-viewer/index.html), loaded from the
session archive CI published — or browse the [Report Gallery](reports.md) for more.

Already have a session archive of your own — from a local run or downloaded from CI? Drop
the `.zip` on the [report viewer](report-viewer/index.html) and it renders in your browser,
with nothing uploaded. See [Open one of your own sessions](reports.md#open-one-of-your-own-sessions-in-the-browser).

<div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(15rem, 1fr)); gap: 1rem; align-items: start; margin: 1.5rem 0;">
  <a href="report-viewer/index.html?zip=../report-assets/clock/session.zip" style="display: block; text-decoration: none;">
  ...
  <a href="report-viewer/index.html?zip=../report-assets/ios-contacts/session.zip" style="display: block; text-decoration: none;">
    <strong>iOS</strong>
  ...
  <a href="report-viewer/index.html?zip=../report-assets/wikipedia/session.zip" style="display: block; text-decoration: none;">
    <strong>Web</strong>
